...
public class BaseAllStuInfos {
   ...
   List<BaseReStuInfo> baseReStuInfoList;


    public BaseAllStuInfos(TeacherInfos teacherInfos,List<BaseReStuInfo> baseReStuInfoList) {
        ...
        this.baseReStuInfoList = baseReStuInfoList;
    }
}
