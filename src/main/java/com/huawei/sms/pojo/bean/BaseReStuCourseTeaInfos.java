...
public class BaseReStuCourseTeaInfos {
    /**
     * 教师id
     */
    private Integer id;
    ...
    List<BaseReStuNoSecretInfos> baseReStuNoSecretInfosList;

    public BaseReStuCourseTeaInfos(TeacherInfos teacherInfos, CourseInfos courseInfos,List<BaseReStuNoSecretInfos> baseReStuNoSecretInfosList) {
        ...
        this.baseReStuNoSecretInfosList = baseReStuNoSecretInfosList;
    }
}
